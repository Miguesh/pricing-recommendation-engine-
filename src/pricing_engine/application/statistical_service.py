        ...
        profiles=(
            ProfileCapability(
                ...
                required_fields=(
                    ...
                    "target_property_features.property_type",
                    "target_property_features.accommodates",
                    "comparables",
                    "input_lineage",
                    "input_lineage[].lineage_id",
                    "input_lineage[].source_family_id",
                    "input_lineage[].source_version",
                    "input_lineage[].observation_hash",
                    "input_lineage[].lineage_hash",
